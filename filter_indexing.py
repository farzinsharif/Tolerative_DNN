...
# ---------------- Configuration ---------------- #
JSON_RANK_PATH = os.path.join('content_for_TMR/90%_Prune', 'filter_ranks_90%_prune.json')       # per‑layer filter‑rank file
IMPORTANCE      = 0.60                                          # top‑k fraction of filters (0–1]
OUTPUT_PATH     = 'content_for_TMR/90%_Prune/filter_indices.json'                 # where to write the result
